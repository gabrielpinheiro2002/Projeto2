...
<body>
  ...
  <header>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
          ...
          <a class="nav-link" href="{{route ('home-index')}}">Quem somos <span class="sr-only">(current)</span></a>
            ...
            @endguest
            <li class="nav-item">
              <a class="nav-link" href="/register">Trabalhe Conosco</a>
            </li>
          </ul>
    ...
    <!-- Intro Section -->
    <div class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url(https://i0.wp.com/gamehall.com.br/wp-content/uploads/2014/11/League-of-Legends-Wallpaper-Full-HD-1920x1080.jpg?ssl=1); background-repeat: no-repeat; background-size: cover; background-position: center center;">
      <div class="mask rgba-black-light">
        <div class="container h-100 d-flex justify-content-center align-items-center">
          <div class="row pt-5 mt-3">
            <div class="col-md-12">
              <div class="text-center">
                <h1 class="h1-reponsive white-text text-uppercase font-weight-bold mb-3 wow fadeInDown" data-wow-delay="0.3s"><strong>Warriors of Legends
                    </strong></h1>
                <hr class="hr-light mt-4 wow fadeInDown" data-wow-delay="0.4s">
                <h5 class="text-uppercase mb-5 white-text wow fadeInDown" data-wow-delay="0.4s"><strong>MASSIVE ONLINE BATTLE ARENA
                    </strong></h5>
  ...
  <main>
    ...
    <div class="container">
      ...
      <section class="section extra-margins pb-3 text-center text-lg-left wow fadeIn" data-wow-delay="0.3s">
        ...
        <!--Section heading-->
        <h2 class="font-weight-bold text-center h1 my-5">Projetos recentes</h2>
        <!--Section description-->
        <p class="text-center grey-text mb-5 mx-auto w-responsive">A BlueDragon Studios foi fundada em 2020 com o objetivo de desenvolver,
            distribuir em sua melhor qualidade , estamos em busca de novos horizontes e novos sucessos assim como WOL, em Breve teremos novidades. </p>
